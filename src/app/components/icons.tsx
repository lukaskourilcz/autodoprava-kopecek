...
import type { FeatureKey } from "@/content/types";

// Equipment icons for the fleet cards. Each component is named after the
// feature it represents, and FEATURE_ICONS maps a vehicle's feature keys to
// the matching icon so there is a single lookup table.

type IconComponent = React.FC<React.SVGProps<SVGSVGElement>>;

const svgDefaults: React.SVGProps<SVGSVGElement> = {
...
export const TourConfigIcon: IconComponent = (props) => (
...
export const RecliningSeatIcon: IconComponent = (props) => (
  <svg {...svgDefaults} {...props}>
    <path
...
export const SeatBeltIcon: IconComponent = (props) => (
  <svg {...svgDefaults} {...props}>
    <path
...
export const AirConditioningIcon: IconComponent = (props) => (
  <svg {...svgDefaults} {...props}>
    <path
...
export const FridgeIcon: IconComponent = (props) => (
  <svg {...svgDefaults} {...props}>
    <path
...
export const ToiletIcon: IconComponent = (props) => (
  <svg {...svgDefaults} {...props}>
    <path
...
export const FEATURE_ICONS: Record<FeatureKey, IconComponent> = {
  tourConfig: TourConfigIcon,
  recliningSeats: RecliningSeatIcon,
  seatBelts: SeatBeltIcon,
