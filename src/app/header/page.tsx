...
{/* Content */}
<div className="absolute left-1/2 top-[70%] transform -translate-x-1/2 -translate-y-1/2 w-5/6 sm:w-3/4 lg:w-2/3 bg-white bg-opacity-60 backdrop-blur-lg rounded-[10px] shadow-xl text-center p-6 border border-white border-opacity-30">
